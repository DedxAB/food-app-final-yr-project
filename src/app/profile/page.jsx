...
import MYIMG from '../../../public/assets/MY.jpg'
...
const profile = () => {
    ...
    return (
        <>
            <div className="flex items-center justify-between p-5 pt-0 bg-white">
                <Link href="/">
            ...
            <div className="flex flex-col items-center p-8 bg-gray-100">
                <div className="'relative rounded-full overflow-hidden shadow-[1px_1px_50px_14px_#e53e3e]">
                    <Image
                ...
                <p className="mt-6 text-2xl font-bold">Piyas Ghosh</p>
            </div>
            ...
            <div className="bg-white mt-2 p-5 rounded-md shadow-lg">
                <p className="flex justify-between font-bold">
                    {" "}
                    <span>Addresses</span>
                    <Button
